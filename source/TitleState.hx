...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			FlxTween.tween(gfDance, {y: 1000}, 1, {ease: FlxEase.bounceOut});
			FlxTween.tween(logoBl, {y: -1000}, 1, {ease: FlxEase.bounceOut});
			FlxTween.tween(titleText, {alpha: 0}, 2, {ease: FlxEase.bounceOut});
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['A mod made by'], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('A lot of funkin people', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('VS Beegie'); // credTextShit.text += '\nFunkin';
